import { SITE_NAME, SECTIONS } from "@/lib/constants";

export const metadata = {
    title: `Terms of Service | ${SITE_NAME}`,
    description: `Read the Terms of Service and usage guidelines for ${SITE_NAME}.`,
};
        ...
        <div className="relative min-h-screen overflow-hidden" style={{ background: "#07070F" }}>
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
                ...
                <div className="mb-16 border-b border-white/8 pb-12">
                    <p className="font-mono text-[11px] tracking-[0.18em] uppercase text-[#22d3ee] mb-4">Legal</p>
                    <h1 className="font-bold tracking-tight text-4xl sm:text-5xl text-white mb-6">Terms of Service</h1>
